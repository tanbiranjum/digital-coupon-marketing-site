<<<<<<< HEAD:manager/view/viewOffer.php
<style>
table, th, td {
...
<a href='../php/createOffer.php'>Create Offer</a> <br/><br/>

<?php 

if (($h = fopen("../database/offer.txt", "r")) !== FALSE)   
{
    echo "<table >";  
	echo "<tr>";    
    ...
    {   
      echo "<tr>";
		  ...
		  <td>{$data[5]}</td><td>{$data[6]}</td><td><a href='../php/editOffer.php?id={$data[0]}'>Edit</a></td>";  //
      echo "</tr>";
    }
    echo "</table>";
...
>>>>>>> remotes/upstream/main:manager/viewOffer.php
