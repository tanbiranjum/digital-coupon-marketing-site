...
<a href='sendCouponToCustomer.php'>Send Coupon To Customer</a><br/><br/>
	...
	<form action="" method="post">
		...
		<legend>Delete Coupon</legend>
			...
			<input type="text" id="offerId" name="offerId" value="<?php echo $data['offer_id'] ?>" readonly style="margin-top:5px;"></input><br/>
			
			<label for="id">Coupon Display Message</label><br/>
			<input type="text" id="couponDisplayMessage" name="couponDisplayMessage" value="<?php echo $data['coupon_display_msg'] ?>" readonly style="margin-top:5px;"></input><br/>
			
			<label for="id">Status</label><br/>
			<input type="text" id="status2" name="status" value="<?php echo $data['status'] ?>" readonly style="margin-top:5px;"></input><br/>
		  
		    <input type="button" name="button" value="Delete" onclick="deleteCoupon()" style="margin-top:5px;">
		</fieldset>
	</form> 
